...
function HighlightLayer({ data, flipped }) {
    const highlights = [];
...
function PieceLayer({ data, flipped, drag }) {
...
function LastMoveLayer({ data, flipped }) {
...
function InputLayer({ data, flipped, boardRef, setDrag }) {
